...
class AutoIndexResponse(object):
    ...
    def get_headers(self) -> bytes:
        ...
        headers += str.format('Set-Cookie: last=%s; Path=/\r\n' % self.last_dir)
...
class FileResponse(object):
    def __init__(self, path, part_range, method='GET'):
        self.method = method
        self.path = path
...
class NonExistResponse(object):
    def __init__(self, method='GET'):
        ...
        self.content = ('<html>\r\n'
                        ...
                        '<hr><center>GH-AutoIndex/' + _version + '</center>\r\n'
                        '</body>\r\n'
                        '</html>\r\n')
...
class RedirectResponse(object):
    def __init__(self, path, method='GET'):
        self.method = method
        self.headers = ('HTTP/1.0 302 Found\r\n'
                        'Content-Type:text/html; charset=utf-8\r\n'
                        'Server: GH-AutoIndex/' + _version + '\r\n'
                        'Location: ' + path + '\r\n'
                        'Connection: close\r\n'
        ...
        self.content = ('<html>\r\n'
                        ...
                        '<head><title>Redirect to last folder</title></head>\r\n'
                        '</body>\r\n'
                        '</html>\r\n')
